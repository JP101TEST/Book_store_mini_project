    ...
    <article>
        <div class="d-flex justify-content-center">
            <div class="w-50">
                ...
                <form action="../operation/edit.php?idISBN=<?php echo $id_isbn; ?>&OImage=<?php echo $imgeB; ?>&OName=<?php echo $bookN; ?>" method="post" class="form-group" enctype="multipart/form-data">
